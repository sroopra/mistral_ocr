...
from ..utils import encode_pdf_to_base64, create_data_url, combine_ocr_pages_to_markdown
...
class OCRProcessor:
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        if not self.api_key:
            raise ValueError("Mistral API key is required. Set MISTRAL_API_KEY or pass api_key parameter.")
    ...
    def get_ocr_response_info(self, pdf_path: str | Path) -> dict:
        ...
        try:
            ...
            raise Exception(f"Error getting OCR response info for {pdf_path}: {e}")